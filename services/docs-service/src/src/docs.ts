...
const userSchema = {
  ...
  properties: {
    ...
    npm_nip: { type: "string", example: "2255069999" },
    ...
    konsentrasi: stringOrNullSchema("Rekayasa Perangkat Lunak"),
    ...
    auth
      ...
      .post("/register/mahasiswa", () => ({}), {
        body: t.Object({
          ...
          password: t.String({ example: "password123" }),
          npm_nip: t.String({ example: "2255069999", description: "NPM numerik. Dua digit awal menentukan kurikulum: sebelum 25 memakai TI-2020, mulai 25 memakai TI-2025." }),
          kode_kelas: t.String({ example: "DSN-ABCD" }),
          ipk: t.Number({ example: 3.82 }),
          current_semester: t.Number({ example: 8 }),
          konsentrasi: t.Optional(t.Union([
            t.Literal("Rekayasa Perangkat Lunak"), t.Literal("Sistem Cerdas"),
            t.Literal("Teknik Komputer"), t.Literal("Teknologi Informasi"),
            t.Literal("Sistem Komputer"),
          ], { description: "Wajib untuk semester 5 ke atas dan harus tersedia pada kurikulum yang ditentukan otomatis dari NPM." })),
          profile_picture: t.Optional(t.String({ format: "binary", description: "Berkas foto profil (jpeg/png)" }))
        }),
        detail: {
          tags: ["Auth"],
          summary: "Registrasi mahasiswa",
          description: "Registrasi akun mahasiswa. angkatan tidak dikirim: tahun masuk dibaca dari dua digit pertama NPM. Sebelum 2025 memakai TI-2020, mulai 2025 memakai TI-2025. konsentrasi wajib untuk semester 5 ke atas.",
